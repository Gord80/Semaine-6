    ...
    <div class="row">
        <div class="col s12">
            ...
            <div class="col s6" id="prev">
                <img src="" alt="image" title="image du produit" class="pic2">
                    </div>
                    <div class="col s6">
                        <div class="row">
                 ...
                 <div class="col s6">
                     ...
                     <?php
                       if (form_error('pro_prix') != NULL)
                        ...
                        <div class="row align-wrapper left-align">
                        ...
                        <div class="row">
                            <div class="col s6 center-align">
                                <input type="submit" value="Ajouter le produit" class="waves-effect waves-purple btn">
                            </div>
                            <div class="col s6 center-align">
                                <a href="<?= site_url('Produits/liste') ?>" title="Lien vers le catalogue" class="waves-effect waves-purple btn cyan accent-4">Retour au catalogue</a>
                            </div>
                        </div>
                    </form>  
                </div>
